...
const articles = [
  {
    ...
    href: "https://shubstack.substack.com/p/on-solving-actual-problems-in-healthcare?utm_source=shubs&utm_medium=website&utm_campaign=thinking",
  },
  {
    ...
    href: "https://shubstack.substack.com/p/same-same-but-different?utm_source=shubs&utm_medium=website&utm_campaign=thinking",
  },
  {
    ...
    href: "https://shubstack.substack.com/p/evaluating-tech-in-healthcare-measuring?utm_source=shubs&utm_medium=website&utm_campaign=thinking",
  },
  {
    ...
    href: "https://shubstack.substack.com/p/spotlight-on-underserved-communities?utm_source=shubs&utm_medium=website&utm_campaign=thinking",
  },
  {
    ...
    href: "https://shubstack.substack.com/p/mental-health-and-digital-health?utm_source=shubs&utm_medium=website&utm_campaign=thinking",
  },
  {
    ...
    href: "https://shubstack.substack.com/p/negotiating-ethical-approaches-to?utm_source=shubs&utm_medium=website&utm_campaign=thinking",
  },
];
...
const episodes = [
  {
    ...
    href: "https://www.gpodh.org/enhancing-newborn-care-in-rural-eastern-congo-how-a-tool-built-alongside-nurses-changed-everything/?utm_source=shubs&utm_medium=website&utm_campaign=thinking",
  },
  {
    ...
    href: "https://www.gpodh.org/how-to-develop-ai-that-addresses-health-inequities/?utm_source=shubs&utm_medium=website&utm_campaign=thinking",
  },
  {
    ...
    href: "https://www.gpodh.org/javier-elkin-digital-innovation-humanitarian/?utm_source=shubs&utm_medium=website&utm_campaign=thinking",
  },
  {
    ...
    href: "https://www.gpodh.org/co-designing-mental-health-solutions-with-young-people-in-rwanda/?utm_source=shubs&utm_medium=website&utm_campaign=thinking",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--sq-muted)] max-w-xl mb-6" style={{ fontFamily: "var(--font-dm-sans)" }}>
                ...
                <a href="https://shubstack.substack.com?utm_source=shubs&utm_medium=website&utm_campaign=thinking" target="_blank" rel="noopener noreferrer" className="text-[var(--sq-amber)] hover:text-[var(--sq-ink)] transition-colors duration-200">
                  Shubstack
                </a>
                , listen to the conversations on the{" "}
                <a href="https://gpodh.org?utm_source=shubs&utm_medium=website&utm_campaign=thinking" target="_blank" rel="noopener noreferrer" className="text-[var(--sq-amber)] hover:text-[var(--sq-ink)] transition-colors duration-200">
                  GPODH podcast
                </a>
                , or{" "}
                ...
                if something raises a question worth exploring further. I respond to everything.
              </p>
              <p className="text-sm text-[var(--sq-muted)]" style={{ fontFamily: "var(--font-dm-sans)" }}>
                If the thinking resonates, <a href="/services" className="text-[var(--sq-amber)] hover:text-[var(--sq-ink)] transition-colors duration-200">see how I work →</a>
              </p>
            </div>
      ...
      <section className="pb-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <FadeIn delay={520} className="flex justify-center mt-10">
            <a
              href="https://shubstack.substack.com?utm_source=shubs&utm_medium=website&utm_campaign=thinking&utm_content=read-more-cta"
              target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-14">
            ...
            <FadeIn delay={120} className="lg:col-span-2 flex flex-col gap-5 justify-center">
              ...
              <a
                href="https://gpodh.org?utm_source=shubs&utm_medium=website&utm_campaign=thinking"
                target="_blank"
                rel="noopener noreferrer"
      ...
      >
        ...
        <FadeIn className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center flex flex-col items-center gap-8">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              href="https://shubstack.substack.com?utm_source=shubs&utm_medium=website&utm_campaign=thinking"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-4 text-sm font-medium text-white rounded transition-colors duration-200"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-4 text-sm font-medium text-white border border-white/40 rounded hover:border-white transition-colors duration-200"
              style={{ fontFamily: "var(--font-dm-sans)" }}
            >
              Listen to GPODH →
            </a>
